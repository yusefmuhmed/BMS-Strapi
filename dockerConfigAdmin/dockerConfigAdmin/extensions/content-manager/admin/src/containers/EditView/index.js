...
const EditView = ({
    ...
    const { currentEnvironment, plugins, formatMessage } = useGlobalContext();

    // Function used to translate labels of EditView
    const getIntlMetadatas = (metadatas) => {
        let intlMetadatas = { ...metadatas };
        intlMetadatas.label = formatMessage({ id: metadatas.label, defaultMessage: metadatas.label });
        return intlMetadatas
    }
    ...
    const configurationsURL = `/plugins/${pluginId}/${isSingleType ? 'singleType' : 'collectionType'
                                                                    ...
                                                                    if (isComponent) {
                                                                        ...
                                                                        return (
                                                                            <FieldComponent
                                                                                ...
                                                                                label={getIntlMetadatas(metadatas).label}
                                                                                max={max}
                                                                                min={min}
                                                                                name={name}
                                                                            />
                                                                    ...
                                                                    return (
                                                                        <div className={`col-${size}`} key={name}>
                                                                            <Inputs
                                                                                ...
                                                                                keys={name}
                                                                                labelIcon={labelIcon}
                                                                                metadatas={getIntlMetadatas(metadatas)}
                                                                            />
                                                                        </div>
                                                                    );
                                                                }
